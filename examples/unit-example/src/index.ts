...
class Example {
  ...
  async main(): Promise<void> {
    ...
    const createCustomerResponse = await this.client.createUnitCustomer(
      customerRequest
    )
    console.log(
      `create customer response: ${JSON.stringify(
    ...
    const createDepositAccountResponse =
      await this.client.createUnitDepositAccount(depositAccountRequest)
    console.log(
      `create deposit account response: ${JSON.stringify(
    ...
    const createPaymentResponse = await this.client.createUnitPayment(
      pendingAchPaymentRequest
    )
    console.log(
      `create ach payment response: ${JSON.stringify(
