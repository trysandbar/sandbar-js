...
type Event = Omit<publicapi.Event, "payload" | "incomplete" | "type"> &
  ...
  type CreateUnitDepositAccountResponse = Omit<publicapi.CreateUnitDepositAccountResponse, "accountResponse" | "accountEntityLinkResponse"> & {
...
export class Client {
  ...
  async createUnitDepositAccount(
    depositAccount: publicapi.UnitDepositAccount): Promise<CreateUnitDepositAccountResponse> {
    ...
    const accountEntityLinkResponse = translateEventResponse(grpcAccountEntityLinkResponse);
